...
func (c *usersService) Call(ctx context.Context, in *proto1.Request, opts ...client.CallOption) (*proto1.Response, error) {
...
func (h *usersHandler) Call(ctx context.Context, in *proto1.Request, out *proto1.Response) error {
